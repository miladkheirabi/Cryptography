There is a grayscale image that is encrypted by vigenere method and attached. Asuming that the value of most redundant pixel is 180, the plain image must be recovered.
The encryption code is written blow:
'''Python
import numpy as np
